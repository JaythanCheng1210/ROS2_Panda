...
class Puppy(Node):
    def __init__(self):
        ...
        self.puppy_action_server_ = ActionServer(   
            self, PuppyAction, 'puppy_action', execute_callback=self.puppy_execute_callback, 
...
# puppy_action_server_
    ...
    def puppy_execute_callback(self, goal_handle):
        ...
        if goal_handle.request.act_name == "stand_up":
            feedback_msg.which_action = 1
